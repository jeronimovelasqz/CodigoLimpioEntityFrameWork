...
namespace CodigoLimpioEntityFrameWork.Controllers
{
    public class ColorsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "idColor,nombreColor,descripcionColor")] Color color)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "idColor,nombreColor,descripcionColor")] Color color)
        {
            if (ModelState.IsValid)
            {
